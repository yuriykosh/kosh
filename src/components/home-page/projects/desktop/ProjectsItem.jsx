  ...
  return (
    ...
    >
      <Link
        ...
        before:w-5 before:h-5 before:border before:border-transparent before:rounded-full before:bg-magenta before:opacity-0 hover:before:bg-magenta hover:before:opacity-100  xl:before:w-6 xl:before:h-6
        transition-all duration-300 before:transition-opacity before:duration-[250ms]
        "
        href={project.link}
      >
